...
<span className="text-xl text-gray-400 block mt-2 mb-10">(And How to Build a Legacy That Lasts)</span>
...
{/* The Warning Section */}
<div className="bg-brand-magenta/10 border-l-4 border-brand-magenta p-8 my-12 rounded-r-lg">
  <h2 className="text-2xl font-bold text-brand-magenta mb-4 mt-0">The Unthinkable Scenario</h2>
  ...
  <p className="text-xl font-bold text-brand-magenta text-center border-t border-b border-brand-magenta/30 py-4">
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
  ...
  {/* Left: Liability */}
  <div className="border border-brand-magenta/30 rounded-xl p-6 bg-gray-800 shadow-sm">
    <div className="text-brand-magenta font-bold uppercase tracking-wider text-sm mb-2">Option A</div>
    <h3 className="text-xl font-bold mb-4 text-white">The Subscription Model</h3>
    <p className="text-gray-400 mb-4">
      A business held together by a complex web of third-party subscriptions.
    </p>
    <div className="flex items-center text-brand-magenta font-medium gap-2">
      <IconTrendingDown className="w-5 h-5" />
      <span>It is a Liability.</span>
    </div>
  ...
  {/* Right: Asset */}
  <div className="border border-brand-gold/30 rounded-xl p-6 bg-gray-800 shadow-sm ring-1 ring-brand-gold/20">
    <div className="text-brand-gold font-bold uppercase tracking-wider text-sm mb-2">Option B</div>
    <h3 className="text-xl font-bold mb-4 text-white">The Custom Asset</h3>
    <p className="text-gray-400 mb-4">
      A business with a self-sufficient, internal engine that just works.
    </p>
    <div className="flex items-center text-brand-gold font-bold gap-2">
      <IconGem className="w-5 h-5" />
      <span>It is an Asset.</span>
    </div>
    <p className="text-sm text-gray-500 mt-2">
...
{/* Final CTA Box */}
<div className="bg-slate-900 text-white p-10 rounded-2xl text-center shadow-xl border border-gray-800">
